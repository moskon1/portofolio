...
export default function GeneratedHospitalityDemo({ slug, initialDemo = null }: { slug: string; initialDemo?: GeneratedHospitalityDemo|null }) {
  const [demo,setDemo] = useState<GeneratedHospitalityDemo|null>(initialDemo);
