...
export default async function handler(req:ApiRequest,res:ApiResponse) {
  ...
  try {
    ...
    const reviews=(generated.reviews||[]).map((review:any)=>({...review,author:plainValue(review.author),location:plainValue(review.location),date:plainValue(review.date),comment:plainValue(review.comment)}));
